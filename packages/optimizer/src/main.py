...
from packages.optimizer.src.pace_glue.strategies import run_relative_strength_index_strategy
...
if (__name__ == "__main__"):
    ...
    asset_data_provider = AssetDataProvider(
        df_path, "BTC_USD", Timeframe.OneDay)

    # print(asset_data_provider.get_asset_name())
    # print(asset_data_provider.get_timeframe())

    print(run_relative_strength_index_strategy(asset_data_provider))
