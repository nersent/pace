...
use super::aroon_indicator::AroonIndicatorData;
...
impl Component<&AroonIndicatorData, Option<TradeDirection>> for AroonStrategy {
    fn next(&mut self, aroon: &AroonIndicatorData) -> Option<TradeDirection> {
